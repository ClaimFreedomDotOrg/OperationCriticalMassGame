...
const IdleScreen = ({ onStart, visualTaps = [], triggerVisualTap }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-start md:justify-center w-full max-w-full min-h-screen bg-black text-cyan-400 font-mono pt-2 px-3 pb-3 md:p-6 text-center overflow-y-auto relative" style={{ WebkitOverflowScrolling: 'touch' }}>
      {/* Visual Taps Overlay */}
