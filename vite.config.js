...
export default defineConfig({
  ...
  // Explicitly pass environment variables for Cloudflare Pages build
  // Only override if process.env has values (Cloudflare), otherwise let Vite use .env file
  define: process.env.VITE_FIREBASE_API_KEY ? {
